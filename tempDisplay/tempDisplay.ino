...
void setup() {
  Serial.begin(115200);
  screen.begin();
  Serial.println("Temperature Update every 10s");

  if(! aht.begin())
  { 
    Serial.println("Could not find AHT Sensor module on I2C");
    Serial.println("Check wiring");
    while(1) delay(10);
  }
  Serial.println("AHT Sensor running");
}
